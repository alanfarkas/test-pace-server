/*
 *	File: @(#)TestPafDataCache.java 	Package: com.palladium.paf.mdb 	Project: Essbase Provider
 ...
 *
 */
public class TestPafDataCache extends TestCase {
	...
	/*
	 * Test method for 'com.palladium.paf.mdb.PafUowCache.PafDataCache(double[], int, int[], boolean[], int[], String)'
	 */
...
//			isSuccess = false;
	...
	/*
	 * Test method for 'com.palladium.paf.mdb.PafUowCache.getAxisCount()'
	 */
	...
	/*
	 * Test method for 'com.palladium.paf.mdb.PafUowCache.setAxisCount(int)'
	 */
	...
	/*
	 * Test method for 'com.palladium.paf.mdb.PafUowCache.getAxisSize()'
	 */
	...
	/*
	 * Test method for 'com.palladium.paf.mdb.PafUowCache.setAxisSize(int[])'
	 */
	...
	/*
	 * Test method for 'com.palladium.paf.mdb.PafUowCache.getBlockSize()'
	 */
	...
	/*
	 * Test method for 'com.palladium.paf.mdb.PafUowCache.getCellCount()'
	 */
	...
	/*
	 * Test method for 'com.palladium.paf.mdb.PafUowCache.getCellValue(int[])'
	 */
	public void testGetCellValue() {
		...
		try {
			...
			// Get Data
//			pafUowCache = esbData.getDataCache(mdxSelect, appDef, activeVersions);
...
//			isSuccess = false;
	...
	/*
	 * Test method for 'com.palladium.paf.mdb.PafUowCache.setCellValue(int[], double)'
	 */
	public void testSetCellValue() {
		...
		try {
			...
			// Get Data
//			pafUowCache = esbData.getDataCache(testCommonParms.getSampleMdxSelect(), appDef, activeVersions);
			...
			for (int i = 0; i < index.length; i++) {
				try {
					...
					pafUowCache.setCellValue(index[i], newCellValue);
					cellValue = pafUowCache.getCellValue(index[i]);
...
//			isSuccess = false;
	...
	/*
	 * Test method for 'com.palladium.paf.mdb.PafUowCache.getColumnCount()'
	 */
	...
	/*
	 * Test method for 'com.palladium.paf.mdb.PafUowCache.getData()'
	 */
	...
	/*
	 * Test method for 'com.palladium.paf.mdb.PafUowCache.setData(double[])'
	 */
	...
	/*
	 * Test method for 'com.palladium.paf.mdb.PafUowCache.getDataSlice()'
	 */
...
//			pafUowCache = esbData.getDataCache(mdxSelect, appDef, activeVersions);
			...
			dataSlice = pafUowCache.getDataSlice(dsParms);
	...
	/*
	 * Test method for 'com.palladium.paf.mdb.PafUowCache.testUpdateDataCache()'
	 */
...
//			logger.info("Displaying data cache...\n" + pafUowCache.toString());
			...
			// Get data slice
			logger.info("Getting data slice");
			pafDataSlice = pafUowCache.getDataSlice(dsParms);
			...
			pafUowCache.update(pafDataSlice, dsParms);
...
//			logger.info("Displaying updated data cache...\n" + pafUowCache.toString());
	...
	/*
	 * Test method for 'com.palladium.paf.mdb.PafUowCache.getDimCount()'
	 */
	...
	/*
	 * Test method for 'com.palladium.paf.mdb.PafUowCache.setDimCount(int[])'
	 */
	...
	/*
	 * Test method for 'com.palladium.paf.mdb.PafUowCache.getDimIndex()'
	 */
...
//			pafUowCache = esbData.getDataCache(mdxSelect, appDef, activeVersions);
			...
			dimensions = pafUowCache.getAllDimensions();
			for (int i = 0; i < dimensions.length; i++) {
				dimension = dimensions[i];
				logger.info("Getting index for dimension [" + i
						+ "]: " + dimension); 
				index = pafUowCache.getAxisIndex(dimension);
...
//			isSuccess = false;
	...
	/*
	 * Test method for 'com.palladium.paf.mdb.PafUowCache.testGetForwardPlannablePeriods()'
	 */
...
//			pafUowCache = esbData.getDataCache(mdxSelect, appDef, activeVersions, lockedPeriods);
			...
			fpPeriods = pafUowCache.getForwardPlannablePeriods();
...
//			isSuccess = false;
	...
	/*
	 * Test method for 'com.palladium.paf.mdb.PafUowCache.getIsSlicerAxis()'
	 */
	...
	/*
	 * Test method for 'com.palladium.paf.mdb.PafUowCache.setIsSlicerAxis(boolean[])'
	 */
	...
	/*
	 * Test method for 'com.palladium.paf.mdb.PafUowCache.getMdxQuery()'
	 */
	...
	/*
	 * Test method for 'com.palladium.paf.mdb.PafUowCache.setMdxQuery(String)'
	 */
	...
	/*
	 * Test method for 'com.palladium.paf.mdb.PafUowCache.testGetOpenPeriods(String, String)'
	 */
...
//			pafUowCache = esbData.getDataCache(mdxSelect, appDef, activeVersions, lockedPeriods);
			...
			openPeriods = pafUowCache.getOpenPeriods(planVersion, currentYear);
			logger.info("Locked Periods: " + StringUtils.arrayToString(lockedPeriods.toArray()));
...
//			}
			...
			openPeriods = pafUowCache.getOpenPeriods(fcstVersion, currentYear);
			logger.info("Locked Periods: " + StringUtils.arrayToString(lockedPeriods.toArray()));
			logger.info("Open Periods: " + StringUtils.arrayToString(openPeriods.toArray()));
			logger.info("");
			
			logger.info("Getting open periods - next year, forecast version");
			openPeriods = pafUowCache.getOpenPeriods(fcstVersion, nextYear);
			logger.info("Locked Periods: " + StringUtils.arrayToString(lockedPeriods.toArray()));
			logger.info("Open Periods: " + StringUtils.arrayToString(openPeriods.toArray()));
			logger.info("");

			logger.info("Getting open periods - current year, " + planVarVersion);
			openPeriods = pafUowCache.getOpenPeriods(planVarVersion, currentYear);
			logger.info("Locked Periods: " + StringUtils.arrayToString(lockedPeriods.toArray()));
			logger.info("Open Periods: " + StringUtils.arrayToString(openPeriods.toArray()));
			logger.info("");
			
			logger.info("Getting open periods - current year, " + fcstVarVersion);
			openPeriods = pafUowCache.getOpenPeriods(fcstVarVersion, currentYear);
			logger.info("Locked Periods: " + StringUtils.arrayToString(lockedPeriods.toArray()));
			logger.info("Open Periods: " + StringUtils.arrayToString(openPeriods.toArray()));
			logger.info("");
...
//			isSuccess = false;
	...
	/*
	 * Test method for 'com.palladium.paf.mdb.PafUowCache.getRowCount()'
	 */
