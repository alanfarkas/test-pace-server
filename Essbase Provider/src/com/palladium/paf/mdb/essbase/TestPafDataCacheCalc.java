/*
 *	File: @(#)TestPafDataCacheCalc.java 	Package: com.palladium.paf.mdb 	Project: Essbase Provider
...
//import com.palladium.paf.eval.PafUowCacheCalc;
...
public class TestPafDataCacheCalc extends TestCase {
	...
	/*
	 * Test method for 'com.palladium.paf.mdb.PafUowCacheCalc.aggDimension(String, PafUowCache, PafBaseTree)'
	 */
...
//			logger.info("Aggregated data..." + pafDataCache.toString());
	...
	/*
	 * Test method for 'com.palladium.paf.mdb.PafUowCacheCalc.aggDimension2(String, PafUowCache, PafBaseTree)'
	 */
...
//			logger.info("Aggregated data..." + pafDataCache.toString());
	...
	/*
	 * Test method for 'com.palladium.paf.mdb.PafUowCacheCalc.aggDimension3(String, PafUowCache, PafBaseTree)'
	 */
