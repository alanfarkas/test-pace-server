/*
 *	File: @(#)PafClientState.java 	Package: com.palladium.paf.state 	Project: Paf Base Libraries
 ...
 *	05/24/06		AFarkas			x.xx			Moved from com.palladium.paf.server (PafServer)
 * 
 */
