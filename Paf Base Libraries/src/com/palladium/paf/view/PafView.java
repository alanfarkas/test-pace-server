/*
 *  File: @(#)PafView.java 	Package: com.palladium.paf.view   Project: Paf Server
...
public class PafView implements IPafView, Cloneable {
    ...
    /* (non-Javadoc)
	 * @see com.palladium.paf.view.IPafView#getDesc()
	 */
    public String getDesc() {
		return desc;
	}
	/* (non-Javadoc)
	 * @see com.palladium.paf.view.IPafView#setDesc(java.lang.String)
	 */
	public void setDesc(String desc) {
		this.desc = desc;
	}
	/* (non-Javadoc)
	 * @see com.palladium.paf.view.IPafView#getHeaders()
	 */
	public PafViewHeader[] getHeaders() {
		return headers;
	}
	/* (non-Javadoc)
	 * @see com.palladium.paf.view.IPafView#setHeaders(com.palladium.paf.view.PafViewHeader[])
	 */
	public void setHeaders(PafViewHeader headers[]) {
		this.headers = headers;
	}
	/* (non-Javadoc)
	 * @see com.palladium.paf.view.IPafView#getName()
	 */
	public String getName() {
		return name;
	}
	/* (non-Javadoc)
	 * @see com.palladium.paf.view.IPafView#setName(java.lang.String)
	 */
	public void setName(String name) {
		this.name = name;
	}
	/* (non-Javadoc)
	 * @see com.palladium.paf.view.IPafView#getViewSections()
	 */
	public PafViewSection[] getViewSections() {
		return viewSections;
	}
	/* (non-Javadoc)
	 * @see com.palladium.paf.view.IPafView#setViewSections(com.palladium.paf.view.PafViewSection[])
	 */
	public void setViewSections(PafViewSection viewSections[]) {
		this.viewSections = viewSections;
	}
    /* (non-Javadoc)
	 * @see com.palladium.paf.view.IPafView#getBackGroundColor()
	 */
    public String getBackGroundColor() {
        return backGroundColor;
    }
    /* (non-Javadoc)
	 * @see com.palladium.paf.view.IPafView#setBackGroundColor(java.lang.String)
	 */
