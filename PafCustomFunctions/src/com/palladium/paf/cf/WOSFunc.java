...
//    	logger.debug("Getting list of periods");
	...
	/* (non-Javadoc)
	 * @see com.palladium.paf.funcs.AbstractFunction#getTriggerIntersections(com.palladium.paf.state.IPafEvalState)
	 */
...
//    	}
	...
	/* (non-Javadoc)
	 * @see com.palladium.paf.funcs.AbstractFunction#changeTriggersFormula(com.palladium.paf.data.Intersection, com.palladium.paf.state.IPafEvalState)
	 */
    ...
    /* (non-Javadoc)
     * @see com.palladium.paf.funcs.AbstractFunction#getMemberDependencyMap(com.palladium.paf.state.IPafEvalState)
     */
