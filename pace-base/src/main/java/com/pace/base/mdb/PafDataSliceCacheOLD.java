 ...
 *
 */
public class PafDataSliceCacheOLD extends PafDataCache {
	...
	private static Logger logger = Logger.getLogger(PafDataSliceCacheOLD.class);
	 ...
	 * @throws PafException 
	 */
	public PafDataSliceCacheOLD(PafDataSliceCacheParms sliceCacheParms) throws PafException {
