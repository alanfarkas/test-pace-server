...
//	public static final String FN_SpringConfig = "spring-config.xml";
	...
	public static final String CALC_TOKEN_PREFIX_UOW_MBRS_MDBFLOOR = "UOWMEMBERS.MDBFLOOR.";
	...
	public static final String FUNC_TOKEN_FIRST_PLAN_YEAR = "[FIRST.PLAN.YEAR]";
	public static final String FUNC_TOKEN_FIRST_NONPLAN_YEAR = "[FIRST.NONPLAN.YEAR]";
	public static final String FUNC_TOKEN_FIRST_PLAN_PERIOD = "[FIRST.PLAN.PERIOD]";
