/*
 * F_PrevCumTest.java
 * Created by Jtest on 9/19/06 5:46:35 PM.
 * Updated by Jtest on 10/18/06 7:19:13 PM, 16 test cases added, 12 test cases removed.
 * Updated by Jtest on 11/9/06 3:01:12 AM, 14 test cases added, 14 test cases removed.
 */
...
import com.palladium.paf.funcs.F_PrevCum;

/**
 * F_PrevCumTest is a unit test class for class F_PrevCum.
 * @see com.palladium.paf.funcs.F_PrevCum
 * @author Parasoft Jtest 8.0
 */
public class F_PrevCumTest extends PackageTestCase {
	 ...
	 * @author Parasoft Jtest 8.0
	 */
	public F_PrevCumTest(String name) {
		super(name);
		/*
	 ...
	 * @see F_PrevCum#calculate(com.palladium.paf.data.Intersection,com.palladium.paf.data.IPafDataCache,com.palladium.paf.state.IPafEvalState)
	 * @author Parasoft Jtest 8.0
	 */
	public void testCalculate1() throws Throwable {
		F_PrevCum THIS = new F_PrevCum();
		// jtest_tested_method
		double RETVAL = THIS.calculate(
			(Intersection) null,
			(IPafDataCache) null,
			(IPafEvalState) null);
		// NullPointerException thrown, originator is arg 3 to <Method com.palladium.paf.funcs.F_PrevCum.calculate(Lcom/palladium/paf/data/Intersection;Lcom/palladium/paf/data/IPafDataCache;Lcom/palladium/paf/state/IPafEvalState;)D>
		// at com.palladium.paf.funcs.F_PrevCum.calculate(F_PrevCum.java:50)
		// jtest_unverified
	}
	...
	public void testCalculate2() throws Throwable {
		...
		double RETVAL = THIS.calculate(
			...
			(IPafDataCache) null,
			var1);
		// NullPointerException thrown, originator is arg 1 to <Method com.palladium.paf.funcs.F_PrevCum.calculate(Lcom/palladium/paf/data/Intersection;Lcom/palladium/paf/data/IPafDataCache;Lcom/palladium/paf/state/IPafEvalState;)D>
		// at com.palladium.paf.funcs.F_PrevCum.calculate(F_PrevCum.java:52)
		// jtest_unverified
	}
	...
	public void testCalculate14() throws Throwable {
		...
		double RETVAL = THIS.calculate(t1, (IPafDataCache) null, var2);
		// NullPointerException thrown
		// at com.palladium.paf.funcs.F_PrevCum.calculate(F_PrevCum.java:55)
		// jtest_unverified
	}
	...
	/**
	 * Test for method: F_PrevCum()
	 * @throws Throwable Tests may throw any Throwable
	 * @see F_PrevCum#F_PrevCum()
	 * @author Parasoft Jtest 8.0
	 */
	public void testF_PrevCum1() throws Throwable {
		// jtest_tested_method
		F_PrevCum THIS = new F_PrevCum();
	 ...
	 * @throws Throwable Tests may throw any Throwable
	 * @see F_PrevCum#getDirtyIntersections(com.palladium.paf.state.IPafEvalState)
	 * @author Parasoft Jtest 8.0
	 */
	public void testGetDirtyIntersections1() throws Throwable {
		...
		// NullPointerException thrown, originator is arg 1 to <Method com.palladium.paf.funcs.F_PrevCum.getDirtyIntersections(Lcom/palladium/paf/state/IPafEvalState;)Ljava/util/Set;>
		// at com.palladium.paf.funcs.F_PrevCum.getDirtyIntersections(F_PrevCum.java:100)
		// jtest_unverified
	}
	...
	public void testGetDirtyIntersections4() throws Throwable {
		...
		// NullPointerException thrown
		// at com.palladium.paf.funcs.F_PrevCum.getDirtyIntersections(F_PrevCum.java:108)
		// jtest_unverified
	}
	...
	public Object stubsGetDirtyIntersections7(
		...
		if (Stubs.matches(method, Set.class)) {
			...
			if (Stubs.matches(method, "iterator", argument_types)) {
				...
				// at com.palladium.paf.funcs.F_PrevCum.getDirtyIntersections(F_PrevCum.java:111)
			}
		}
	...
	public Object stubsGetDirtyIntersections12(
		...
		if (Stubs.matches(method, IPafEvalState.class)) {
			...
			if (Stubs.matches(method, "getCurrentTimeSlice", argument_types)) {
				return null;
				// at com.palladium.paf.funcs.F_PrevCum.getDirtyIntersections(F_PrevCum.java:113)
			}
		}
		if (Stubs.matches(method, Map.class)) {
			argument_types = new Class[] { Object.class };
	...
	public void testGetDirtyIntersections17() throws Throwable {
		...
		// at java.util.WeakHashMap.getEntry(WeakHashMap.java:370)
		// at java.util.WeakHashMap.containsKey(WeakHashMap.java:361)
		// at com.palladium.paf.funcs.F_PrevCum.getDirtyIntersections(F_PrevCum.java:112)
		// jtest_unverified
	}
	 ...
	 * 
	 * Usage: java com.palladium.paf.funcs.F_PrevCumTest
	...
	public static junit.framework.Test suite() {
		...
		// this class
			...
			"com.palladium.paf.funcs.F_PrevCum",
