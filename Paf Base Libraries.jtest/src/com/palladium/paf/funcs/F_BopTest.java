/*
 * F_BopTest.java
 * Created by Jtest on 9/19/06 5:35:46 PM.
 * Updated by Jtest on 10/18/06 7:18:08 PM, 12 test cases added, 12 test cases removed.
 * Updated by Jtest on 11/9/06 2:49:52 AM, 12 test cases added, 12 test cases removed.
 */
...
import com.palladium.paf.funcs.F_Bop;

/**
 * F_BopTest is a unit test class for class F_Bop.
 * @see com.palladium.paf.funcs.F_Bop
 * @author Parasoft Jtest 8.0
 */
public class F_BopTest extends PackageTestCase {
	 ...
	 * @see F_Bop#calculate(com.palladium.paf.data.Intersection,com.palladium.paf.data.IPafDataCache,com.palladium.paf.state.IPafEvalState)
	 * @author Parasoft Jtest 8.0
	 */
	public void testCalculate1() throws Throwable {
		F_Bop THIS = new F_Bop();
		// jtest_tested_method
		double RETVAL = THIS.calculate(
			(Intersection) null,
			(IPafDataCache) null,
			(IPafEvalState) null);
		// NullPointerException thrown, originator is arg 3 to <Method com.palladium.paf.funcs.F_Bop.calculate(Lcom/palladium/paf/data/Intersection;Lcom/palladium/paf/data/IPafDataCache;Lcom/palladium/paf/state/IPafEvalState;)D>
		// at com.palladium.paf.funcs.F_Bop.calculate(F_Bop.java:47)
		// jtest_unverified
	}
	...
	public void testCalculate2() throws Throwable {
		...
		double RETVAL = THIS.calculate(
			...
			(IPafDataCache) null,
			var1);
		// NullPointerException thrown, originator is arg 1 to <Method com.palladium.paf.funcs.F_Bop.calculate(Lcom/palladium/paf/data/Intersection;Lcom/palladium/paf/data/IPafDataCache;Lcom/palladium/paf/state/IPafEvalState;)D>
		// at com.palladium.paf.funcs.F_Bop.calculate(F_Bop.java:49)
		// jtest_unverified
	}
	...
	public void testCalculate14() throws Throwable {
		...
		_f4 = Intersection.createIntersection(
			var1,
			(List) null,
			(List) null,
			(List) null);
		...
		double RETVAL = THIS.calculate(t1, (IPafDataCache) null, var2);
		// NullPointerException thrown
		// at com.palladium.paf.funcs.F_Bop.calculate(F_Bop.java:52)
		// jtest_unverified
	}
	...
	/**
	 * Test for method: F_Bop()
	 * @throws Throwable Tests may throw any Throwable
	 * @see F_Bop#F_Bop()
	 * @author Parasoft Jtest 8.0
	 */
	public void testF_Bop1() throws Throwable {
		// jtest_tested_method
		F_Bop THIS = new F_Bop();
	 ...
	 * @throws Throwable Tests may throw any Throwable
	 * @see F_Bop#getDirtyIntersections(com.palladium.paf.state.IPafEvalState)
	 * @author Parasoft Jtest 8.0
	 */
	public void testGetDirtyIntersections1() throws Throwable {
		...
		// NullPointerException thrown, originator is arg 1 to <Method com.palladium.paf.funcs.F_Bop.getDirtyIntersections(Lcom/palladium/paf/state/IPafEvalState;)Ljava/util/Set;>
		// at com.palladium.paf.funcs.F_Bop.getDirtyIntersections(F_Bop.java:74)
		// jtest_unverified
	}
	...
	public void testGetDirtyIntersections4() throws Throwable {
		...
		// NullPointerException thrown
		// at com.palladium.paf.funcs.F_Bop.getDirtyIntersections(F_Bop.java:75)
		// jtest_unverified
	}
	...
	public void testGetDirtyIntersections6() throws Throwable {
		...
		// at com.palladium.paf.funcs.F_Bop.getDirtyIntersections(F_Bop.java:83)
		// jtest_unverified
	}
	...
	public Object stubsGetDirtyIntersections6(
		...
		if (Stubs.matches(method, IPafEvalState.class)) {
			...
			argument_types = new Class[0];
			if (Stubs.matches(method, "getFirstTimeSlice", argument_types)) {
				return null;
				// at com.palladium.paf.funcs.F_Bop.getDirtyIntersections(F_Bop.java:79)
			}
			argument_types = new Class[0];
	 ...
	 * @author Parasoft Jtest 8.0
	 */
	public void testGetDirtyIntersections8() throws Throwable {
		F_Bop THIS = new F_Bop();
		_f0 = new PafApplicationDef();
		SeasonList t2 = new SeasonList();
		MdbDef t3 = new MdbDef();
	...
	/**
	 * Stubs method for testGetDirtyIntersections8.
	 * @param method The method or constructor to be called
	 * @param _this The instance object corresponding to the method or
	 *        <code>null</code> for static methods
	 * @param args The arguments passed to the method
	 ...
	 * @author Parasoft Jtest 8.0
	 */
	public Object stubsGetDirtyIntersections8(
		Member method,
		Object _this,
		Object[] args) throws Throwable {
		Class[] argument_types;
	 ...
	 * @author Parasoft Jtest 8.0
	 */
	public void testGetDirtyIntersections11() throws Throwable {
		F_Bop THIS = new F_Bop();
		_f0 = new PafApplicationDef();
		SeasonList t2 = new SeasonList();
		MdbDef t3 = new MdbDef();
	...
	/**
	 * Stubs method for testGetDirtyIntersections11.
	 * @param method The method or constructor to be called
	 * @param _this The instance object corresponding to the method or
	 *        <code>null</code> for static methods
	 * @param args The arguments passed to the method
	 ...
	 * @author Parasoft Jtest 8.0
	 */
	public Object stubsGetDirtyIntersections11(
		Member method,
		Object _this,
		Object[] args) throws Throwable {
		Class[] argument_types;
	 ...
	 * @author Parasoft Jtest 8.0
	 */
	public void testGetDirtyIntersections13() throws Throwable {
		F_Bop THIS = new F_Bop();
		_f0 = new PafApplicationDef();
		SeasonList t2 = new SeasonList();
		MdbDef t3 = new MdbDef();
		...
		_f4 = Intersection.createIntersection(
			...
			(List) null);
		String[] var2 = new String[] { "", "" };
		_f5 = Intersection.createIntersection(
			var2,
			(List) null,
			(List) null,
			(List) null);
		...
		IPafEvalState var8 = (IPafEvalState) Stubs
			.makeStubObject(IPafEvalState.class);
		// jtest_tested_method
		Set RETVAL = THIS.getDirtyIntersections(var8);
		// NullPointerException thrown
	...
	/**
	 * Stubs method for testGetDirtyIntersections13.
	 * @param method The method or constructor to be called
	 * @param _this The instance object corresponding to the method or
	 *        <code>null</code> for static methods
	 * @param args The arguments passed to the method
	 ...
	 * @author Parasoft Jtest 8.0
	 */
	public Object stubsGetDirtyIntersections13(
		Member method,
		Object _this,
		Object[] args) throws Throwable {
		Class[] argument_types;
	 ...
	 * 
	 * Usage: java com.palladium.paf.funcs.F_BopTest
...
private MdbDef _f3;
	 ...
	 * @author Parasoft Jtest 8.0
	 */
private com.palladium.paf.data.Intersection _f4;
	/**
	 * Used to pass information between test method and stubs methods.
	 * @author Parasoft Jtest 8.0
	 */
private com.palladium.paf.data.Intersection _f5;
									}

// JTEST_CURRENT_ID=-1598472470.