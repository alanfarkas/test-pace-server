/*
 *	File: @(#)ES_ProcessReplication.java 	Package: com.palladium.paf.eval 	Project: PafServer
...
public class ES_ProcessReplication implements IEvalStep {
    ...
    /* (non-Javadoc)
     * @see com.palladium.paf.eval.IEvalStep#performEvaluation(com.palladium.paf.state.EvalState)
     */
