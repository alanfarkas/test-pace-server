/*
 *  File: @(#)PafServiceProvider.java   Package: com.palladium.paf.server   Project: PafServer
					...
					if (isDataFiltered){
						...
						if(dataFilterSpec != null && dataFilterSpec.getDimSpec().length > 0){
							...
							for(PafDimSpec pafDimSpec : nonHierDimSpecs){
								...
								if (pafDimSpec.getExpressionList()[0].contains(com.palladium.paf.PafBaseConstants.UOW_ROOT)){
								...
								else if(pafDimSpec.getExpressionList()[0].contains(com.palladium.paf.PafBaseConstants.PLAN_VERSION)){
...
//	}
	...
	/* (non-Javadoc)
	 * @see com.palladium.paf.server.IPafService#renameMemberTagData(com.palladium.paf.server.comm.PafFilteredMbrTagRequest)
	 */
