/*
 *	File: @(#)PafCellNoteManager.java 	Package: com.palladium.paf.server 	Project: PafServer
...
//			try to Close session if not single session
	...
	public CellNotesInformation[] getCellNotesInformation() throws PafException {
		...
		try {
			...
			//create buffer
			StringBuffer strBuff = new StringBuffer("select new com.palladium.paf.db.cellnotes.CellNotesInformation ( cellNote.application.name, cellNote.dataSource.name, count(cellNote) ) ");
